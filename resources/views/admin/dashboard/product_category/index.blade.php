            ...
            <div class="card-body">
                ...
                <div class="form-group clearfix">
                    <div class="icheck-primary">
                        <input type="radio" id="R1" value="SPECIAL" name="type" v-model="category.code">
                        <label for="R1">
                            {{_i('SPECIAL')}}
                        </label>
                    </div>
...
<script>
    ...
    Echo.private(`created-action`)
        .listen('ProductCategoryAction', (e) => {
            nav_vue.updateNotificationCounts(e);
        }).listen('custom-action',(e)=>{
            console.log('Custom Action : '+ e);
        });

    var basic_url = `{{route('product_category.index')}}`;
    var vue = new Vue({
        el: "#app",
        data: {
            url: basic_url,
        ...
        methods: {
            ...
            uploadFile: function() {
                ...
                let fd = new FormData();
                let url = `{{route('web.product_category.upload')}}`;
            ...
            reset: function() {
                ...
                this.url = `{{route('product_category.index')}}`;
                this.errors = {};
            },
            newOption: function() {
            ...
            },
            {
                ...
                render: function(data, row, type, meta) {
                    if (data) {
                        ...
                        return `<img alt="{{_i('No Image')}}" class="profile-user-img img-fluid img-circle" src="{{$default_image}}">`;
                    }
